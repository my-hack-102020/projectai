...
public class Property2__ {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("text", text).append("additionalProperties", additionalProperties).toString();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Property2__) == false) {
            return false;
        }
        Property2__ rhs = ((Property2__) other);
