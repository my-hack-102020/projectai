...
public class Templates {
    ...
    private Property1__ property1;
    @JsonProperty("property2")
    private Property2__ property2;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("property1")
    public Property1__ getProperty1() {
        return property1;
    }

    @JsonProperty("property1")
    public void setProperty1(Property1__ property1) {
        this.property1 = property1;
    }

    @JsonProperty("property2")
    public Property2__ getProperty2() {
        return property2;
    }

    @JsonProperty("property2")
    public void setProperty2(Property2__ property2) {
